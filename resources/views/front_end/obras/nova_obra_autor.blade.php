...
<article class="post">
    ...
    @if(count($errors))
        ...
        @endif
        <h3>Form</h3>
        <form method="POST" action="{{Route('add.obra')}}" enctype="multipart/form-data">
            @csrf
            <div class="row gtr-uniform">
                <div class="col-6 col-12-xsmall">
                    <input type="text" name="titulo" id="titulo" value="" placeholder="Título da Obra" />
                </div>
                <div class="col-6 col-12-xsmall">
                    <input type="text" name="subtitulo" id="subtitulo" value="" placeholder="Subtítulo da Obra" />
                </div>
                <div class="col-12">
                    <input type="text" name="breveDescricao" id="breveDescricao" value="" placeholder="Faça uma breve descrição da Obra" />
                </div>
                <div class="col-12">
                    <textarea name="sinopse" id="sinopse" placeholder="Escreva a Sinopse" rows="6"></textarea>
                </div>
                <div class="col-6 col-12-xsmall">
                ...
                <div class="col-12">
                    <ul class="actions">
                        ...
                        <li><input type="submit" value="Adicionar" /></li>
                    </ul>
                </div>
            </div>
        </form>
